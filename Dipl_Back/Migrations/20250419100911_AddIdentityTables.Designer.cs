...
namespace Dipl_Back.Migrations
{
    ...
    [Migration("20250419100911_AddIdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dipl_Back.Models.Tables.Main.UserBookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("UserBookmarks_PK");

                    b.HasIndex("IdBook");

                    b.HasIndex(new[] { "UserEmail" }, "IX_UserBookmarks_UserEmail");

                    b.HasIndex(new[] { "UserEmail", "IdBook" }, "UC_UserBookmarks")
                        .IsUnique();
