...
begin transaction        
insert into Books(Title, BookImage, IdAuthor, IdGenre, IdAge, Price, CreationYear, AmountRatings, Rating, BookDescription) 
values
    ('Анна Коренина',                     'tolstoi_korenina.jpg',      3, 13, 4, 3000, 1830, 0, 0.0, 'Роман о трагической любви замужней дамы Анны Карениной и блестящего офицера Алексея Вронского'),    -- 1
    ('Евгений Онегин',                    'pushlin_onegin.jpg',        1, 13, 4, 3000, 1830, 0, 0.0, 'Одно из самых значимых произведений русской литературы'),    -- 2
    ('Над пропастью во ржи',              'selidjer_roj.jpg',          9, 13, 4, 1800, 1951, 0, 0.0, 'От лица 17-летнего юноши по имени Холден Колфилд откровенно рассказывается о его обострённом восприятии американской действительности'),    -- 3
    ('Преступление и наказание',          'dostoevskii_nakazanie.jpg', 2, 13, 3, 3500, 1866, 0, 0.0, 'Социально-психологический и социально-философский роман.'),    -- 4
    ('Война и мир',                       'tolstoi_mir.jpg',           3, 13, 4, 3010, 1873, 0, 0.0, 'В романе рассказывается о французском вторжении в Россию и влиянии наполеоновской эпохи на царское общество через истории пяти русских аристократических семей.'),    -- 5
    ('Метро 2033',                        'glukhovskii_metro.jpg',     7, 14, 5, 2700, 2005, 0, 0.0, 'Постапокалиптический роман Дмитрия Глуховского, описывающий жизнь людей в московском метро после ядерной войны на Земле.'),    -- 6
    ('Ведьмак. Последнее желание',        'sapkovskii_vedmak.jpg',     8,  6, 4, 3000, 1986, 0, 0.0, 'Сборник рассказов писателя Анджея Сапковского в жанре фэнтези, объединённых общим персонажем — ведьмаком Геральтом из Ривии.'),    -- 7
    ('Гарри Поттер и философский камень', 'rouling_potter.jpg',       10,  6, 2, 1800, 1995, 0, 0.0, 'Фэнтезийный роман британской писательницы Джоан Роулинг. Первая часть в серии книг о Гарри Поттере и дебютный роман Роулинг.'),    -- 8
    ('Оно',                               'king_ono.jpg',             11,  2, 4, 3500, 1986, 0, 0.0, 'Роман американского писателя. В произведении затрагиваются важные для Кинга темы: власть памяти, сила объединённой группы и влияние детских психологических травм на взрослую жизнь. '),    -- 9
    ('Божественная комедия',              'olegeri_komedia.jpg',       5, 16, 3, 3010, 1321, 0, 0.0, 'Поэма, написанная Данте Алигьери в период приблизительно с 1308 по 1321 год и дающая наиболее широкий синтез средневековой культуры и онтологии мира. '),    -- 10
    ('11/22/63',                          'king_112263.jpg',          11,  1, 4, 2700, 2011, 0, 0.0, 'Научно-фантастический роман американского писателя Стивена Кинга, рассказывающий о путешественнике во времени, пытающемся предотвратить убийство 35-го президента США Джона Кеннеди.');    -- 11
commit transaction;
...
insert into Sales(IdPubBook, SaleDate, Amount, SalePrice, DeliverPrice) 
values
    (69, '2024-10-14', 12, 12500, 700),    -- 1
    (69, '2024-10-15',  1,  3000, 200),    -- 2
    (69, '2024-10-16',  3,  9000, 200),    -- 3
    (69, '2024-10-15', 16, 16000, 200);    -- 4
commit transaction;
