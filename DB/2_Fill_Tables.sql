...
begin transaction        
insert into Books(Title, BookImage, IdAuthor, IdGenre, IdAge, Price, CreationYear, AmountRatings, Rating) 
values
    ('Анна Коренина',                     'tolstoi_korenina.jpg',      3, 13, 4, 3000, 1830, 0, 0.0),    -- 1
    ('Евгений Онегин',                    'pushlin_onegin.jpg',        1, 13, 4, 3000, 1830, 0, 0.0),    -- 2
    ('Над пропастью во ржи',              'selidjer_roj.jpg',          9, 13, 4, 1800, 1951, 0, 0.0),    -- 3
    ('Преступление и наказание',          'dostoevskii_nakazanie.jpg', 2, 13, 3, 3500, 1866, 0, 0.0),    -- 4
    ('Война и мир',                       'tolstoi_mir.jpg',           3, 13, 4, 3010, 1873, 0, 0.0),    -- 5
    ('Метро 2033',                        'glukhovskii_metro.jpg',     7, 14, 5, 2700, 2005, 0, 0.0),    -- 6
    ('Ведьмак. Последнее желание',        'sapkovskii_vedmak.jpg',     8,  6, 4, 3000, 1986, 0, 0.0),    -- 7
    ('Гарри Поттер и философский камень', 'rouling_potter.jpg',       10,  6, 2, 1800, 1995, 0, 0.0),    -- 8
    ('Оно',                               'king_ono.jpg',             11,  2, 4, 3500, 1986, 0, 0.0),    -- 9
    ('Божественная комедия',              'olegeri_komedia.jpg',       5, 16, 3, 3010, 1321, 0, 0.0),    -- 10
    ('11/22/63',                          'king_112263.jpg',          11,  1, 4, 2700, 2011, 0, 0.0);    -- 11
commit transaction;
